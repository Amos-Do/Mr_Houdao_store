    ...
    <div class="container p-3 p-md-4">
      ...
      <div class="row detail mb-5">
        ...
        <div class="col-md-6">
          <h2>{{ product.title }}</h2>
          <span
            class="orange-price d-block"
            v-if="product.origin_price"
          >{{ product.origin_price | currency }} 元</span>
          ...
          <form class="border-bottom border-gray-600 py-4 mb-4">
            <div class="input-group align-items-end mb-4">
              ...
              <button
                ...
                @click="qty++"
              >＋</button>
              <strong class="flex-grow-1 text-right">
                小計： {{ (product.price * qty) | currency }}元
              </strong>
            </div>
            <button
              type="button"
