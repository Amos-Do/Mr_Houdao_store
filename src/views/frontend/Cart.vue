      ...
      <div class="my-4" v-if="cart.total">
        <table class="table">
              ...
              <td class="align-middle cart-product">
                ...
                <div class="d-md-none mt-3">
                  <div class="input-group">
                    <button
                      class="btn btn-sm btn-outline-primary mr-1 px-1 rounded"
                    ...
                    />
                    <button
                      class="btn btn-sm btn-outline-primary ml-1 px-1 rounded"
          ...
          <tfoot>
              ...
              <td colspan="5">
                <div class="input-group input-group-sm mr-auto w-100">
                  <input
                    type="text"
                    class="form-control"
                    placeholder="請輸入 houdao 或 code 看看"
                    v-model="couponCode"
                  />
            ...
            <tr>
              <td colspan="3" class="d-md-table-cell d-none">
