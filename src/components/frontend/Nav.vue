        ...
        <div class="nav-item dropdown cart-icon order-md-2">
          ...
          <div class="dropdown-menu dropdown-menu-right px-2" aria-labelledby="navbarDropdown">
            <div class="mt-3 text-center" v-if="!cart.total">
              <p>購物車是空的！</p>
              <router-link to="/products" class="btn btn-secondary w-100 text-light">
                前往購物商場
              </router-link>
            </div>
            <div v-else>
              ...
              <router-link to="/cart" class="btn btn-secondary w-100 text-light mt-2 btn-cart">
                查看我的購物車
              </router-link>
            </div>
          </div>
